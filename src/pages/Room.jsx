    ...
    useEffect(() => {
        ...
        const unsubscribe = client.subscribe(`databases.${DATABASE_ID}.collections.${COLLECTION_ID_MESSAGES}.documents`, 
            response => {
                ...
                console.log("SUBSCRIBED AND LISTENING")
    ...
    return (
        <main className="container">
            ...
            <div className="room--container">
                ...
                <div className="message--col" id="scrollbar">
                    {messages.map(message => (
                        <div key={message.$id} className={message.user_id !== user.$id ? "message--wrapper-left" : `message--wrapper-right`}>
